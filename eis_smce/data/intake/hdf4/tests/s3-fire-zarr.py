...
from eis_smce.data.intake.hdf4.drivers import HDF4FileSource
...
h4s: HDF4FileSource = HDF4FileSource( data_file_url  )                        # Creates source encapsulating all matched files in data_url

...
cache_path = "/att/nobackup/tpmaxwel/ILAB/scratch"
...
if __name__ == '__main__':
    ...
    h4s = intake.open_hdf4( data_url, cache_dir=f"{cache_path}/{collection}" )
    h4s.export( output_file, cat_path=f"s3://{bucketname}/catalog" )

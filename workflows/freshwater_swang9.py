...
eisc( cache = "/discover/nobackup/tpmaxwel/cache", mode = "eis.freshwater.swang9" )
...
#            output=f"s3://{bucket}/{s3_prefix}/SURFACEMODEL/LIS_HIST.d01.zarr" ),
            output=f"/discover/nobackup/tpmaxwel/cache/eis.freshwater.swang9/output/SURFACEMODEL/LIS_HIST.d01.zarr" ),

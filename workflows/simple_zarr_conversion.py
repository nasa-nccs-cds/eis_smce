...
input_path1 = "/discover/nobackup/projects/eis_freshwater/swang9/OL_10km/OUTPUT.1980.imerg.fixed/SURFACEMODEL/*/LIS_HIST*.nc"
input_path = "/discover/nobackup/projects/eis_freshwater/swang9/OL_1km/OUTPUT.RST.2013/ROUTING/*/LIS_HIST*.nc"    # 170 GB
input_files = glob.glob( input_path )
merge_dim = "time"
cache_dir = "/discover/nobackup/tpmaxwel/cache"
zarr_file = f"{cache_dir}/test.1km.routing.zarr"

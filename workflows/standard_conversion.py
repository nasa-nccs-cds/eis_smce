...
routing_2013_1km = dict(  input=f"file:/{input_dir}/swang9/OL_1km/OUTPUT.RST.2013/ROUTING/**/LIS_HIST*.nc",
                          output=f"{output_dir}/LIS/OL_1km/ROUTING/LIS_HIST.d01"  )
merra_2000_1km = dict(  input=f"file:/{input_dir}/swang9/OL_1km/OUTPUT.RST.2000/SURFACEMODEL/**/LIS_HIST*.nc",
                        output=f"{output_dir}/LIS/OL_1km/2000_2021/MERRA/LIS_HIST.d01"  )
merra_imerg_2000_1km = dict(  input=f"file:/{input_dir}/swang9/OL_1km/OUTPUT.RST.2000.imerg.fixed/SURFACEMODEL/*/LIS_HIST*.nc",
